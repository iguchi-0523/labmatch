...
_最終更新: 2026-07-10 11:08:16 JST_
...
```
  ...
  ✓ 農業・食品産業技術総合研究機構        145 labs
  ✓ 国立精神・神経医療研究センター        142 labs
  ✓ 同志社大学                  134 labs
  ✓ 明治大学                   113 labs
...
■ 部分取り込み (1〜49 labs): 3 機関
  ...
  · 理化学研究所                 20 labs
  · カブリ数物連携宇宙研究機構（Kavli IPMU） 6 labs

■ 子センター (parent 付き、研究機関): 74 件
...
■ config に登録されている総数: 72 機関（大学 + 公的研究機関 + 学内研究所）
  残: 約 17 機関 (4 本/日 cron で約 5 日で完走)
```
